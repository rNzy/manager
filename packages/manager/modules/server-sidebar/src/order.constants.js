...
export const SIDEBAR_ORDER_CONFIG = [
  ...
  {
    id: 'order-additional-ip-legacy',
    title: 'ip',
    icon: 'ovh-font ovh-font-ip',
    state: 'app.ip.dashboard.order-legacy',
    linkId: 'DEDICATED',
    linkPart: '#/configuration/ip/order-legacy',
    app: [DEDICATED],
    regions: ['EU', 'CA'],
  },
  {
    id: 'order-additional-ip-us',
    title: 'ip',
    icon: 'ovh-font ovh-font-ip',
    state: 'app.ip.dashboard.order',
    linkId: 'DEDICATED',
    linkPart: '#/configuration/ip/order',
    app: [DEDICATED],
    regions: ['US'],
  },
  {
